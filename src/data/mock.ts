...
export const plans = [
  {
    ...
    period: "/mois",
    credits: 100,
    features: ["100 crédits / mois", "Générations standard", "Export MP3", "Bibliothèque privée"],
    current: true,
  },
  {
    id: "creator",
    ...
    period: "/mois",
    credits: 1500,
    features: ["1 500 crédits / mois", "Voix haute fidélité", "Export WAV & stems", "Clips 1080p"],
    current: false,
    highlight: true,
  },
  {
